...
import com.fungame.songquiz.controller.response.AcceptedInviteResponse;
import com.fungame.songquiz.controller.response.ApiResponse;
import com.fungame.songquiz.controller.response.SentInviteResponse;
...
public class RoomInviteController {
    ...
    public ApiResponse<SentInviteResponse> invite(
        ...
        return ApiResponse.success(SentInviteResponse.from(SentInvite.from(sent)));
    }
    ...
    public ApiResponse<AcceptedInviteResponse> accept(
        ...
        return ApiResponse.success(
                AcceptedInviteResponse.from(roomInviteService.accept(inviteId, member.getId())));
    }
