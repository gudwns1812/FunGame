    ...
    <div className="relative flex flex-col min-h-screen">
      ...
      <header className="flex items-center justify-between border-b border-primary/30 px-6 py-4 bg-background-dark/80 backdrop-blur-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-widest uppercase text-primary neon-glow">FunGame 대기실</h1>
            <p className="text-[10px] text-primary/60 tracking-[0.2em]">서버 통신 중: 정상</p>
          </div>
        </div>
